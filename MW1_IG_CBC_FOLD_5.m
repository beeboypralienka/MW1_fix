...
%---
    ...
    %---
        ...
        iTraining = 1; 
        iTesting = 1;                     
        for iBarisData = 1 : length(MW1_01_IG)            
            if MW1_00_TrainIdx(iBarisData,iFold) == 1 %---- TRAINING                 
                MW1_02_Train{1,iFitur}{iFold,1}(iTraining,1:iFitur) = MW1_01_IG(iTraining,1:iFitur); 
                MW1_02_Train{1,iFitur}{iFold,1}(iTraining,iFitur+1) = MW1_01_IG(iTraining,38); % Tambah kelas
                MW1_02_Train{1,iFitur}{iFold,1}(iTraining,iFitur+2) = iBarisData; % Tambah urutan data
                iTraining = iTraining + 1;            
            else %---- TESTING                                        
                MW1_03_Test{1,iFitur}{iFold,1}(iTesting,1:iFitur) = MW1_01_IG(iTesting,1:iFitur);            
                MW1_03_Test{1,iFitur}{iFold,1}(iTesting,iFitur+1) = MW1_01_IG(iTesting,38); % Tambah kelas
