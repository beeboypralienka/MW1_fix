...
%---
    ...
    %---            
        ...
        for iBarisData = 1 : size(MW1_01_GR,1)  %Iterasi baris data 
            %---- TRAINING
            if MW1_00_TrainIdx(iBarisData,iFold) == 1 %Kalau TrainIdx 1                 
                MW1_02_Train{1,iFitur}{iFold,1}(iTraining,1:iFitur) = MW1_01_GR(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur
                MW1_02_Train{1,iFitur}{iFold,1}(iTraining,iFitur+1) = MW1_01_GR(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "MW1_01_GR"
            ...
            %---- TESTING
                ...
                MW1_03_Test{1,iFitur}{iFold,1}(iTesting,1:iFitur) = MW1_01_GR(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur           
                MW1_03_Test{1,iFitur}{iFold,1}(iTesting,iFitur+1) = MW1_01_GR(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "MW1_01_GR"
...
MW1_57_MAX_Mean_BAL = [urutan nilai size(MW1_01_GR,2)-1 toc seed]; %Simpan ke 'MW1_57_MAX_Mean_BAL'
clear nilai urutan;
