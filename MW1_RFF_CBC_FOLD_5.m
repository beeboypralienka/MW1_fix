...
% Load file RFF 
%--------------
MW1_01_RFF = csvread('03_SeleksiFitur\MW1_RFF\MW1_RFF.csv');
...
%-------------
k = 5;
vektorMW1 = MW1_01_RFF(:,1);
cvFolds = crossvalind('Kfold', vektorMW1, k);
clear vektorMW1; 
    
disp('MW1_RFF Calculation in progress...');
...
%---
    ...
    %---            
        ...
        for iBarisData = 1 : size(MW1_01_RFF,1)  %Iterasi baris data 
            %---- TRAINING
            if MW1_00_TrainIdx(iBarisData,iFold) == 1 %Kalau TrainIdx 1                 
                MW1_02_Train{1,iFitur}{iFold,1}(iTraining,1:iFitur) = MW1_01_RFF(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur
                MW1_02_Train{1,iFitur}{iFold,1}(iTraining,iFitur+1) = MW1_01_RFF(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "MW1_01_RFF"
            ...
            %---- TESTING
                ...
                MW1_03_Test{1,iFitur}{iFold,1}(iTesting,1:iFitur) = MW1_01_RFF(iBarisData,1:iFitur); %Sengaja dipisah kelasnya, karena ada iterasi fitur           
                MW1_03_Test{1,iFitur}{iFold,1}(iTesting,iFitur+1) = MW1_01_RFF(iBarisData,end); %Tambah kelas dari kolom paling terakhir di "MW1_01_RFF"
...
MW1_57_MAX_Mean_BAL = [urutan nilai size(MW1_01_RFF,2)-1 toc seed]; %Simpan ke 'MW1_57_MAX_Mean_BAL'
clear nilai urutan;
...
disp('Saving...');
    tic
        save('04_CBC\MW1_RFF_CBC_FOLD_5.mat');        
    toc
disp('Done!');
